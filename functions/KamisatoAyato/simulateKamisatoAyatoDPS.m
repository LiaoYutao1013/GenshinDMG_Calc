function [totalDMG, dps, breakdown, rotationTime] = simulateKamisatoAyatoDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.E = struct('TalentGroup', "Skill", 'Param', "WaterIllusionDMG", 'DamageField', "SkillDMGBonus", ...
        ...
        'PostSetSkillActiveTime', 6.0, 'Note', "Takimeguri Kanka");
    actions.S1 = struct('TalentGroup', "Skill", 'Param', "Shunsuiken1HitDMG", 'DamageField', "NormalDMGBonus", ...
        ...
        'FlatDamageBonus', burstNormalBonus, 'AllowAmplify', double(vapeReady), 'Note', "Shunsuiken 1");
    actions.S2 = struct('TalentGroup', "Skill", 'Param', "Shunsuiken2HitDMG", 'DamageField', "NormalDMGBonus", ...
        ...
        'FlatDamageBonus', burstNormalBonus, 'AllowAmplify', double(vapeReady), 'Note', "Shunsuiken 2");
    actions.S3 = struct('TalentGroup', "Skill", 'Param', "Shunsuiken3HitDMG", 'DamageField', "NormalDMGBonus", ...
        ...
        'FlatDamageBonus', burstNormalBonus, 'AllowAmplify', double(vapeReady), 'Note', "Shunsuiken 3");
