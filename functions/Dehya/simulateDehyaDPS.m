function [totalDMG, dps, breakdown, rotationTime] = simulateDehyaDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.E1 = struct('TalentGroup', "Skill", 'Param', "IndomitableFlameDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Pyro", 'BaseMultiplier', 1.00, 'HPWeight', skillHPWeight, ...
    ...
    actions.QFist = struct('TalentGroup', "Burst", 'Param', "FlameManesFistDMG", 'MVOverride', fistATKMV, 'ActionScalingMode', "ATK", ...
        ...
        'HitCount', burstHitCount, 'CritRateBonus', burstCritRateBonus, 'CritDMGBonus', burstCritDMGBonus, ...
    ...
    actions.FieldPost = struct('TalentGroup', "Skill", 'Param', "FieldDMG", 'MVOverride', fieldATKMV, 'ActionScalingMode', "ATK", ...
        ...
        'HitCount', fieldPostHitCount, 'BaseMultiplier', 1.00, 'AllowAmplify', allowAmplify, 'Note', "Recreated Fiery Sanctum");
