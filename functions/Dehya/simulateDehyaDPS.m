function [totalDMG, dps, breakdown, rotationTime] = simulateDehyaDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.E1 = struct('TalentGroup', "Skill", 'Param', "IndomitableFlameDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Pyro", 'BaseMultiplier', 1.00, 'HPWeight', skillHPWeight, 'Note', "Molten Inferno cast");
    actions.FieldPre = struct('TalentGroup', "Skill", 'Param', "FieldDMG", 'MVOverride', fieldATKMV, 'ActionScalingMode', "ATK", ...
        'DamageField', "SkillDMGBonus", 'ActionElement', "Pyro", 'HPWeight', fieldHPWeight, 'HitCount', 3, 'Note', "Fiery Sanctum coordinated attacks");
    actions.QFist = struct('TalentGroup', "Burst", 'Param', "FlameManesFistDMG", 'MVOverride', fistATKMV, 'ActionScalingMode', "ATK", ...
        ...
        'HitCount', burstHitCount, 'CritRateBonus', burstCritRateBonus, 'CritDMGBonus', burstCritDMGBonus, 'Note', "Flame-Mane's Fist");
    actions.Drive = struct('TalentGroup', "Burst", 'Param', "IncinerationDriveDMG", 'MVOverride', driveATKMV, 'ActionScalingMode', "ATK", ...
        ...
        'CritRateBonus', burstCritRateBonus, 'CritDMGBonus', burstCritDMGBonus, 'Note', "Incineration Drive");
    ...
    actions.FieldPost = struct('TalentGroup', "Skill", 'Param', "FieldDMG", 'MVOverride', fieldATKMV, 'ActionScalingMode', "ATK", ...
        ...
        'HitCount', fieldPostHitCount, 'BaseMultiplier', 1.00, 'Note', "Recreated Fiery Sanctum");
