...
function contribution = localAccumulateStat(contribution, statType, statValue)
    ...
    switch lower(char(statType))
        ...
        case {'reactiondmgbonus'}
            contribution.ReactionDMGBonus = contribution.ReactionDMGBonus + statValue;
        case {'physicaldmgbonus'}
            contribution.PhysicalDMGBonus = contribution.PhysicalDMGBonus + statValue;
        case {'shieldbonus'}
            contribution.ShieldBonus = contribution.ShieldBonus + statValue;
        case {'lunarchargedbonus'}
            contribution.LunarChargedBonus = contribution.LunarChargedBonus + statValue;
        case {'pyrodmgbonus'}
...
function fields = localTrackedFields()
    fields = { ...
        ...
        'LunarChargedBonus', 'StellarSwirlBonus', ...
        'NormalDMGBonus', 'ChargeDMGBonus', 'ChargedDMGBonus', 'PlungeDMGBonus', ...
        'SkillDMGBonus', 'BurstDMGBonus', 'HealingBonus', 'ReactionDMGBonus', 'ShieldBonus', 'ResShred'};
end
