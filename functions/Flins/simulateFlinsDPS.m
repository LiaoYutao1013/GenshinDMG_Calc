                ...
                if state.LampTime > 0
                    ...
                    if lunarChargedEnabled
                        reactionDMG = calcReactionDamage(getTalentValue(talent, 'Reaction', 'LunarCharged', talentLevel), ...
                            ...
                            1 + getFieldOrDefault(build, 'ReactionDMGBonus', 0) + getFieldOrDefault(build, 'LunarChargedBonus', 0) ...
                            + getFieldOrDefault(teamContext, 'LunarChargedBonus', 0) + 0.05 * state.PhantomCount, ...
