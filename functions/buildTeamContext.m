function teamContext = buildTeamContext(members, rotationDuration, sharedBuffs, enemy)
    ...
    stellarSwirlEnabled = hasSandrone && hasOdette && anemoCount >= 1 && cryoCount >= 1;
    ...
    stellarGlimmerBonus = getFieldOrDefault(sharedBuffs, 'StellarGlimmerBonus', 0) ...
        + getFieldOrDefault(sharedArtifactBuffs, 'StellarGlimmerBonus', 0);
    ...
    stellarSwirlBonus = getFieldOrDefault(sharedBuffs, 'StellarSwirlBonus', 0);
    if hasOdette && stellarSwirlEnabled
        odetteIndex = find(memberNames == "Odette", 1, 'first');
        odetteATK = localApproxMemberATK(members{odetteIndex}, 335);
        stellarSwirlBonus = stellarSwirlBonus + min(0.14, 0.00007 * max(0, odetteATK));
    end
    ...
    teamContext = struct( ...
        ...
        'EnemyCount', max(1, round(getFieldOrDefault(enemy, 'EnemyCount', 1))), ...
        'TargetCount', max(1, round(getFieldOrDefault(enemy, 'TargetCount', getFieldOrDefault(enemy, 'EnemyCount', 1)))), ...
        ...
        'CombatEventTable', getFieldOrDefault(sharedBuffs, 'CombatEventTable', table()), ...
        ...
        'StellarSwirlEnabled', stellarSwirlEnabled, ...
        ...
        'StellarGlimmerBonus', stellarGlimmerBonus, ...
        'StellarSwirlBonus', stellarSwirlBonus, ...
        'QiqiC6StellarConductFlatDamage', qiqiC6StellarConductFlatDamage, ...
