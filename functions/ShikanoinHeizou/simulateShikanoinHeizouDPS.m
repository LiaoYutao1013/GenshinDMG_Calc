function [totalDMG, dps, breakdown, rotationTime] = simulateShikanoinHeizouDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.Swirl1 = struct('TalentGroup', "Skill", 'Param', "DeclensionDMGBonus", 'MVOverride', 0, ...
        ...
        'ReactionElement', "Anemo", 'ReactionBaseDamage', 723.0, 'PostAddStacks', 1, 'PostMaxStacks', 4, 'ApplyGauge', 0, 'CanApplyAura', false, ...
    ...
    actions.E = struct('TalentGroup', "Skill", 'Param', "SkillDMG", 'DamageField', "SkillDMGBonus", ...
        ...
        'CritRateBonus', c1OpeningStack * 0.00, 'LunarisAttackName', "ElementalArt_Strike", 'LunarisDamageParam', "Heizo_ElementalArt_Base_Damage", 'Note', "Heartstopper Strike tap");
    ...
    actions.EFull = struct('TalentGroup', "Skill", 'Param', "SkillDMG", 'DamageField', "SkillDMGBonus", ...
        ...
        'PostSetStacks', 0, 'LunarisAttackName', "ElementalArt_Strike_Max", 'LunarisDamageParam', "Heizo_ElementalArt_Base_Damage|Heizo_ElementalArt_Level_Damage|4.000000|MUL|ADD|Heizo_ElementalArt_Extra_Damage|ADD", 'Note', "Heartstopper Strike full declension");
    actions.Q = struct('TalentGroup', "Burst", 'Param', "FudouStyleVacuumSluggerDMG", 'DamageField', "BurstDMGBonus", ...
        'ActionElement', "Anemo", 'BaseMultiplier', 1.00, 'LunarisAttackName', "ElementalBurst_WindHole", 'LunarisDamageParam', "Heizo_ElementalBurst_WindHole_Damage", 'Note', "Vacuum Slugger");
    actions.Iris = struct('TalentGroup', "Burst", 'Param', "WindmusterIrisDMG", 'DamageField', "BurstDMGBonus", ...
        ...
        'PreferredAmplifyAura', localResolveIrisPreferredAura(teamContext, enemy), 'LunarisAttackName', "ElementalBurst_WindHole", 'LunarisDamageParam', "Heizo_ElementalBurst_AfterShock_Damage", 'Note', "Windmuster Iris");
