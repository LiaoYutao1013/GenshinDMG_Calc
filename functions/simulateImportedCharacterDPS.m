...
function spec = localBuildImportedSpec(characterName, meta, build, teamContext)
    ...
    actions = struct();
    actions.N1 = localMakeAction("Normal", localSelectFirstExistingParam(characterName, "Normal", ...
        ["x1HitDMG", "NA1ATK", "N1", "Attack1ATK"]), ...
        damagePreference.NormalField, damagePreference.NormalElement, reactionFlags, "Normal 1");
    actions.N2 = localMakeAction("Normal", localSelectFirstExistingParam(characterName, "Normal", ...
        ["x2HitDMG", "NA2ATK", "N2", "Attack2ATK"]), ...
        damagePreference.NormalField, damagePreference.NormalElement, reactionFlags, "Normal 2");
    actions.N3 = localMakeAction("Normal", localSelectFirstExistingParam(characterName, "Normal", ...
        ["x3HitDMG", "NA3ATK", "N3", "Attack3ATK"]), ...
        damagePreference.NormalField, damagePreference.NormalElement, reactionFlags, "Normal 3");
    actions.Charged = localMakeAction("Normal", localSelectFirstExistingParam(characterName, "Normal", ...
        ["ChargedAttackDMG", "ChargedATK", "ChargedAttackFinalDMG", "ChargedAttackLoopDMG", "ChargedAttack", "AimedShotChargeLevel1", "AimedShot"]), ...
    ...
    actions.Plunge = localMakeAction("Normal", localSelectFirstExistingParam(characterName, "Normal", ...
        ["HighPlungeATK", "HighPlungeDMG", "LowPlungeATK", "LowHighPlungeDMG", "PlungeATK", "PlungeDMG"]), ...
    ...
    actions.E = localMakeAction("Skill", localSelectFirstExistingParam(characterName, "Skill", ...
        ["SkillDMG", "ElementalSkillDMG", "DMG", "Stage1DMG", "SpiritOrbDMG", "CastATK", "ShotATK", "DashATK", "RushATK", "ConfirmATK", "SkyladderATK"]), ...
    ...
    actions.E2 = localMakeAction("Skill", localSelectFirstExistingParam(characterName, "Skill", ...
        ["Stage2DMG", "SecondaryDMG", "FollowUpDMG", "EnhancedSkillDMG", "LoadedShotATK", "SprintATK", "ThrowATK", "ImpactATK", "LeapATK", "Driftcloud1ATK"]), ...
    ...
    actions.Q = localMakeAction("Burst", localSelectFirstExistingParam(characterName, "Burst", ...
        ["BurstDMG", "ElementalBurstDMG", "RitualDMG", "WaterBallDMG", "CastATK", "GrenadeATK", "White1ATK", "Dark1ATK", "DuskBoltDMGIncrease"]), ...
    ...
    actions.QLoop = localMakeAction("Burst", localSelectFirstExistingParam(characterName, "Burst", ...
        ["WaterBallDMG", "SoundwaveCollisionDMG", "DuskBoltDMGIncrease", "AdditionalDMG", "WaveDMG", "SecondaryGrenadeATK", "BoltATK", "StarwickerATK", "ProjectionATK", "WhiteDragonATK", "DarkDragonATK"]), ...
