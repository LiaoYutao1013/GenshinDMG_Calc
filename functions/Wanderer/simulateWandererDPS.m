function [totalDMG, dps, breakdown, rotationTime, audit] = simulateWandererDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    % 风姿态下的空居·不�?空居·刀风倍率记录�?Skill 天赋表中�?    % 这里显式使用 Skill 分组，避免去 Normal 表读取不到对应字段�?    actions.N1 = struct('TalentGroup', "Skill", 'Param', "KuugoFushoudanDMG", 'DamageField', "NormalDMGBonus", ...
