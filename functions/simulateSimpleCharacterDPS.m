        ...
        if ~isstruct(actionSpec) || isempty(fieldnames(actionSpec))
            ...
            for hitIndex = 1:hitCount %#ok<NASGU>
                hitDMG = localDirectElementDamage( ...
                    actionElement, scaleComponent, mv * dynamicMultiplier, build, teamContext, enemy, ...
                    extraBonus, effectiveCritRate, effectiveCritDMG);
                ...
                if logical(getFieldOrDefault(actionSpec, 'AllowCatalyze', 0))
                    [catalyzeDMG, catalyzeName] = localResolveCatalyzeDamage( ...
                        actionElement, build, teamContext, enemy, extraBonus, effectiveCritRate, effectiveCritDMG, reactionBonus, actionSpec);
                ...
                if logical(getFieldOrDefault(actionSpec, 'AllowTransformative', 0))
                    ...
                    if reactionBase > 0
                        ...
                        resShred = localElementResShred(reactionElement, build, teamContext);
                        reactionCritRate = [];
                        reactionCritDMG = [];
...
function [damage, reactionName] = localResolveCatalyzeDamage( ...
        element, build, teamContext, enemy, extraBonus, critRate, critDMG, reactionBonus, actionSpec)
    damage = 0;
    reactionName = "";
    ...
    damage = localDirectElementDamage( ...
        element, 1, additiveFlat, build, teamContext, enemy, extraBonus, critRate, critDMG);
end
