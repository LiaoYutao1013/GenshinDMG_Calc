function [totalDMG, dps, breakdown, rotationTime, audit] = simulateFreminetDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.E = struct('TalentGroup', "Skill", 'Param', "UpwardThrustDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Cryo", 'BaseMultiplier', 1.00, ...
        'LunarisAttackName', "ElementalArt_Strike", 'LunarisDamageParam', "Damage", 'Note', "Pressurized Floe");
    actions.Frost = struct('TalentGroup', "Skill", 'Param', "FrostDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Cryo", 'BaseMultiplier', 1.00, ...
        'LunarisAttackName', "ElementalArt_2", 'LunarisDamageParam', "Ice_Damage_Calculated", 'Note', "Pers frost wave");
    actions.BFrost = struct('TalentGroup', "Skill", 'Param', "FrostDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Cryo", 'BaseMultiplier', 2.00, ...
        'LunarisAttackName', "ElementalArt_2", 'LunarisDamageParam', "Ice_Damage_Calculated", 'Note', "Burst-enhanced frost wave");
    actions.P4 = struct('TalentGroup', "Skill", 'Param', "Level4ShatteringPressureDMG", 'DamageField', "SkillDMGBonus", ...
        ...
        'CritRateBonus', 0.15 * double(constellation >= 1), 'LunarisAttackName', "ElementalArt_3", 'LunarisDamageParam', "Phy0", ...
        'StrikeType', "Blunt", 'CanShatter', true, 'ApplyGauge', 0, 'CanApplyAura', false, 'Note', "Level 4 Shattering Pressure");
    actions.Q = struct('TalentGroup', "Burst", 'Param', "SkillDMG", 'DamageField', "BurstDMGBonus", ...
        'ActionElement', "Cryo", 'BaseMultiplier', 1.00, 'PostSetBurstActiveTime', 10.0, ...
        'LunarisAttackName', "ElementalBurst_Strike", 'LunarisDamageParam', "Damage", 'Note', "Shadowhunter's Ambush");
    actions.Thorn = struct('TalentGroup', "Skill", 'Param', "SpiritbreathThornDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Cryo", 'BaseMultiplier', 1.00, ...
        'LunarisAttackName', "ArkheGrade", 'LunarisDamageParam', "Arkhe_Damage", 'ApplyGauge', 0, 'CanApplyAura', false, 'Note', "Spiritbreath Thorn");
