        ...
        switch action
                ...
                if state.ShadowDanceTime > 0 && state.VerdantDew > 0
                    ...
                    if constellation >= 6 && mod(state.PhantasmCount, 2) == 0
                        extraDMG = calcReactionDamage(900 + 0.25 * currentEM, currentEM, enemy, currentResShred, ...
                            1 + getFieldOrDefault(build, 'ReactionDMGBonus', 0) + getFieldOrDefault(teamContext, 'LunarBloomBonus', 0), ...
            ...
            case 'LunarBloom'
                if lunarBloomEnabled
                    ...
                    reactionBonus = 1 + getFieldOrDefault(build, 'ReactionDMGBonus', 0) + getFieldOrDefault(teamContext, 'LunarBloomBonus', 0) ...
