function [totalDMG, dps, breakdown, rotationTime, audit] = simulateKukiShinobuDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    actions.E = struct('TalentGroup', "Skill", 'Param', "SkillDMG", 'DamageField', "SkillDMGBonus", ...
        'ActionElement', "Electro", 'BaseMultiplier', 1.00, 'AllowCatalyze', double(aggravateReady), 'PostSetSkillActiveTime', 12.0, ...
        'LunarisAttackName', "ElementalArt", 'LunarisDamageParam', "ElementalArt_OnceAttack_Damage", ...
        'ApplyGauge', 1.0, 'ICDRule', "Independent", 'Note', "Sanctifying Ring setup");
    actions.Ring = struct('TalentGroup', "Skill", 'Param', "GrassRingOfSanctificationDMG", 'DamageField', "SkillDMGBonus", ...
        ...
        'HitCount', 6 + double(constellation >= 2), 'AllowCatalyze', double(aggravateReady), ...
        'LunarisAttackName', "ElementalArt_TickLogic", 'LunarisDamageParam', "Elemental_Art_TickDamage", ...
        'ApplyGauge', 1.0, 'ICDRule', "Independent", 'Note', "Sanctifying ring");
    actions.Q = struct('TalentGroup', "Burst", 'Param', "SingleInstanceDMG", 'DamageField', "BurstDMGBonus", ...
        ...
        'HitCount', 8 + 2 * double(constellation >= 2), 'AllowCatalyze', double(aggravateReady), ...
        'LunarisAttackName', "ElementalBurst_Gadget", 'ApplyGauge', 1.0, 'ICDRule', "Independent", 'Note', "Gyoei Narukami Kariyama Rite");
