function [totalDMG, dps, breakdown, rotationTime] = simulateCharlotteDPS(build, enemy, seqFile, talentLevel, constellation, teamContext)
    ...
    defaultRotation = {'EHold', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Q', 'Kamera', 'Kamera', 'Kamera', 'Kamera'};
    if constellation >= 6
        defaultRotation = {'EHold', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Mark', 'Q', 'Kamera', 'Kamera', 'C6Assist', 'Kamera', 'Kamera', 'C6Assist'};
    end
    ...
    spec = struct( ...
        ...
        'ActionTimeMap', struct('EHold', 0.95, 'Mark', 1.50, 'Q', 1.05, 'Kamera', 0.85, 'C6Assist', 0.10), ...
        'Actions', actions);
